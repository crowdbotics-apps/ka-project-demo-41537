...
const kaprojectdemoAPI = axios.create({
  baseURL: "https://ka-project-demo-41537.botics.co",
  headers: { Accept: "application/json", "Content-Type": "application/json" }
})
function api_docs_schema_retrieve(payload) {
  return kaprojectdemoAPI.get(`/api-docs/schema/`, {
    params: { lang: payload.lang }
  })
}
function api_v1_login_create(payload) {
  return kaprojectdemoAPI.post(`/api/v1/login/`, payload.data)
}
function api_v1_signup_create(payload) {
  return kaprojectdemoAPI.post(`/api/v1/signup/`, payload.data)
}
function modules_social_auth_apple_connect_create(payload) {
  return kaprojectdemoAPI.post(
...
function modules_social_auth_socialaccounts_list(payload) {
  return kaprojectdemoAPI.get(`/modules/social-auth/socialaccounts/`)
}
...
function rest_auth_login_create(payload) {
  return kaprojectdemoAPI.post(`/rest-auth/login/`, payload.data)
}
function rest_auth_logout_retrieve(payload) {
  return kaprojectdemoAPI.get(`/rest-auth/logout/`)
}
function rest_auth_logout_create(payload) {
  return kaprojectdemoAPI.post(`/rest-auth/logout/`)
}
function rest_auth_password_change_create(payload) {
  return kaprojectdemoAPI.post(`/rest-auth/password/change/`, payload.data)
}
function rest_auth_password_reset_create(payload) {
  return kaprojectdemoAPI.post(`/rest-auth/password/reset/`, payload.data)
}
...
function rest_auth_registration_create(payload) {
  return kaprojectdemoAPI.post(`/rest-auth/registration/`, payload.data)
}
...
function rest_auth_user_retrieve(payload) {
  return kaprojectdemoAPI.get(`/rest-auth/user/`)
}
function rest_auth_user_update(payload) {
  return kaprojectdemoAPI.put(`/rest-auth/user/`, payload.data)
}
function rest_auth_user_partial_update(payload) {
  return kaprojectdemoAPI.patch(`/rest-auth/user/`, payload.data)
}
